...
def bandit_retrieval(passage_ids: list, passage_embeddings: list, passages: list, llm: LLM, query, query_embedding, query_id, beta=2.0, llm_budget: int=10, k_cold_start: int=5, k_retrieval: int=10, batch_size: int=10, verbose: bool=False, return_score: bool=False) -> list:
    """
