...
class PointRec:
    ...
    def load_dataset(self):
        ...
        with open(f"data/point_rec/relevance/qrels.trec", "r", encoding='utf-8') as f:
    ...
    def load_data(self, country):
        ...
        self.queries, self.passages, self.qrels_iter, self.passage_dict, self.cities, self.pois, prelabel_relevance = self.load_dataset(country=country)
